#рекурс функц, перемещ робота до упора в задан направл, ставящую возле перегородки маркер и возвращ робота в исходное положение
using HorizonSideRobots
rob = Robot("task20.sit", animate = true)
